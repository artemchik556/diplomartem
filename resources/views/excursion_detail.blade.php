        ...
        <section class="excursion-banner">
            ...
            <div class="excursion-info">
                ...
                <div class="guide-info">
                    <h3><i class="fas fa-user-tie"></i> Гиды</h3>
                    <ul>
                        <li>Группа A: {{ $excursion->guideA ? $excursion->guideA->name . ' ' : 'Не указан' }}</li>
                        <li>Группа B: {{ $excursion->guideB ? $excursion->guideB->name . ' ' : 'Не указан' }}</li>
                        <li>Группа C: {{ $excursion->guideC ? $excursion->guideC->name . ' ' : 'Не указан' }}</li>
                    </ul>
                </div>
            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="group_a">
                                        Группа A (Осталось мест: {{ $excursion->availableSeats('a', request('excursion_date', $excursion->start_date->format('Y-m-d'))) ?? '0' }}) - {{ $excursion->guideA ? $excursion->guideA->name : 'Гид не указан' }}
                                    </label>
                                </div>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="group_b">
                                        Группа B (Осталось мест: {{ $excursion->availableSeats('b', request('excursion_date', $excursion->start_date->format('Y-m-d'))) ?? '0' }}) - {{ $excursion->guideB ? $excursion->guideB->name : 'Гид не указан' }}
                                    </label>
                                </div>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="group_c">
                                        Группа C (Осталось мест: {{ $excursion->availableSeats('c', request('excursion_date', $excursion->start_date->format('Y-m-d'))) ?? '0' }}) - {{ $excursion->guideC ? $excursion->guideC->name : 'Гид не указан' }}
                                    </label>
                                </div>
                            </div>
