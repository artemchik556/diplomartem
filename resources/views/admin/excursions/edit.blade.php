...
<div class="container">
    ...
    <form action="{{ route('admin.excursions.update', $excursion->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="start_date" name="start_date" value="{{ old('start_date', $excursion->start_date) }}" required>
            @error('start_date')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="date" class="form-control" id="end_date" name="end_date" value="{{ old('end_date', $excursion->end_date) }}" required>
            @error('end_date')
                <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="guide_id" name="guide_id" required>
                ...
                @forelse($guides as $guide)
                    <option value="{{ $guide->id }}" {{ old('guide_id', $excursion->guide_id) == $guide->id ? 'selected' : '' }}>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="preparation_level" name="preparation_level" rows="2">{{ old('preparation_level', $excursion->preparation_level) }}</textarea>
